...
namespace WoWmapperX.ConsolePort
{
    ...
    {
        private readonly List<Keybind> _bindings = AppSettings.Default.CustomBindings
            ? BindManager.CurrentKeybinds
            : Defaults.KeybindStyles.GetDefault(AppSettings.Default.ModifierStyle);
        ...
        public BindDictionary()
        {
            ...
            if (AppSettings.Default.ButtonStyle == 0)
            {
            ...
            else if (AppSettings.Default.ButtonStyle == 1)
            {
                _dict.Add("TYPE", "PS4");
            }
            else if (AppSettings.Default.ButtonStyle == 2)
            {
                _dict.Add("TYPE", "XBOX");
            }
            
            _dict.Add("TOGGLERUN", "NUMPADDIVIDE");
            _dict.Add("ID", AppSettings.Default.BindingsModified.ToFileTimeUtc().ToString());
        }
