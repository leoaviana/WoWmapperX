...
namespace WoWmapperX.Controllers.DS4
{
    public class DS4Controller : IController
    {
        ...
        public int GetAxis(GamepadAxis axis)
        {
            ...
            var cState = Ds4.getRawCurrentState();
        ...
        public String GetDeviceName()
        {
            ...
            { 
                ...
                case DS4Windows.InputDevices.InputDeviceType.JoyConR:
                    return "JoyCon Right";
                case DS4Windows.InputDevices.InputDeviceType.JoyConGrip:
                    return "JoyCon Grip";
        ...
        private void MonitorThread()
        {
            while (_running)
            {
                ...
                var cState = ds4.getRawCurrentState();
                var pState = ds4.getRawPreviousState();
                ...
                if ((cState.L2 > AppSettings.Default.TriggerThresholdLeft) &&
                ...
                if (cState.R2 > AppSettings.Default.TriggerThresholdRight &&
