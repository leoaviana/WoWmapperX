...
namespace DS4Windows
{
    public class HidDeviceCapabilities
    {
        ...
        private static unsafe short[] ConvertShortPointerToArray(short* pointer, int length)
        {
        ...
        internal unsafe HidDeviceCapabilities(NativeMethods.HIDP_CAPS capabilities)
        {
            ...
            reserved = ConvertShortPointerToArray(capabilities.Reserved, 17);
