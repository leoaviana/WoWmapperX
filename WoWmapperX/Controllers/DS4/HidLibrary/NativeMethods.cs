...
namespace DS4Windows
{
    ...
    internal static partial class NativeMethods
    {
        ...
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static partial Boolean DeviceIoControl(IntPtr DeviceHandle, UInt32 IoControlCode, ref long InBuffer, Int32 InBufferSize, IntPtr OutBuffer, Int32 OutBufferSize, ref Int32 BytesReturned, IntPtr Overlapped);

        [LibraryImport("kernel32.dll", SetLastError = true)]
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static partial Boolean DeviceIoControl(IntPtr DeviceHandle, UInt32 IoControlCode, IntPtr InBuffer, Int32 InBufferSize, IntPtr OutBuffer, Int32 OutBufferSize, ref Int32 BytesReturned, IntPtr Overlapped);
        ...
        [LibraryImport("kernel32.dll", SetLastError = true, EntryPoint = "QueryDosDeviceW", StringMarshalling = StringMarshalling.Utf16)]
        internal static partial uint QueryDosDevice(string lpDeviceName, IntPtr lpTargetPath, int ucchMax);
        ...
        [LibraryImport("kernel32.dll", SetLastError = true)]
        [return: MarshalAs(UnmanagedType.Bool)]
        static internal partial bool CancelIo(IntPtr hFile);

        [LibraryImport("kernel32.dll", SetLastError = true)]
        [return: MarshalAs(UnmanagedType.Bool)]
        static internal partial bool CancelIoEx(IntPtr hFile, IntPtr lpOverlapped);
		
        [return: MarshalAs(UnmanagedType.Bool)]
        [LibraryImport("kernel32.dll", SetLastError = true)]
        static internal partial bool CancelSynchronousIo(IntPtr hObject);

		/*
	    [LibraryImport("kernel32.dll", EntryPoint = "CreateEventW", StringMarshalling = StringMarshalling.Utf16)]
	    static internal partial IntPtr CreateEvent(ref SECURITY_ATTRIBUTES securityAttributes, int bManualReset, int bInitialState, string lpName);

	    [LibraryImport("kernel32.dll", EntryPoint = "CreateFileW", StringMarshalling = StringMarshalling.Utf16, SetLastError = true)]
	    static internal partial IntPtr CreateFile(string lpFileName, uint dwDesiredAccess, int dwShareMode, ref SECURITY_ATTRIBUTES lpSecurityAttributes, int dwCreationDisposition, int dwFlagsAndAttributes, int hTemplateFile);
		*/

        [LibraryImport("kernel32.dll", EntryPoint = "CreateFileW", StringMarshalling = StringMarshalling.Utf16, SetLastError = true)]
        internal static partial SafeFileHandle CreateFile(String lpFileName, UInt32 dwDesiredAccess, Int32 dwShareMode, IntPtr lpSecurityAttributes, Int32 dwCreationDisposition, UInt32 dwFlagsAndAttributes, Int32 hTemplateFile);

        [LibraryImport("kernel32.dll", SetLastError = true)]
        [return: MarshalAs(UnmanagedType.Bool)]
        static internal partial bool ReadFile(IntPtr hFile, [Out] byte[] lpBuffer, uint nNumberOfBytesToRead, out uint lpNumberOfBytesRead, IntPtr lpOverlapped);

	    [LibraryImport("kernel32.dll")]
	    static internal partial uint WaitForSingleObject(IntPtr hHandle, int dwMilliseconds);

		/*
        [LibraryImport("kernel32.dll")]
        [return: MarshalAs(UnmanagedType.Bool)]
        static internal partial bool WriteFile(IntPtr hFile, byte[] lpBuffer, uint nNumberOfBytesToWrite, out uint lpNumberOfBytesWritten, ref System.Threading.NativeOverlapped lpOverlapped);
		*/
        ...
        internal unsafe struct SP_DEVICE_INTERFACE_DETAIL_DATA
        {
            ...
            internal fixed char DevicePath[256];
        }
        ...
        [LibraryImport("setupapi.dll", EntryPoint = "SetupDiGetDeviceRegistryPropertyW", StringMarshalling = StringMarshalling.Utf16)]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static partial bool SetupDiGetDeviceRegistryProperty(IntPtr deviceInfoSet, ref SP_DEVINFO_DATA deviceInfoData, int propertyVal, ref int propertyRegDataType, byte[] propertyBuffer, int propertyBufferSize, ref int requiredSize);
	
        [LibraryImport("setupapi.dll", EntryPoint = "SetupDiGetDevicePropertyW", StringMarshalling = StringMarshalling.Utf16, SetLastError = true)]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static partial bool SetupDiGetDeviceProperty(IntPtr deviceInfo, ref SP_DEVINFO_DATA deviceInfoData, ref DEVPROPKEY propkey, ref ulong propertyDataType, byte[] propertyBuffer, int propertyBufferSize, ref int requiredSize, uint flags);

	    [LibraryImport("setupapi.dll")]
        [return: MarshalAs(UnmanagedType.Bool)]
        static internal partial bool SetupDiEnumDeviceInfo(IntPtr deviceInfoSet, int memberIndex, ref SP_DEVINFO_DATA deviceInfoData);

	    [LibraryImport("user32.dll")]
	    static internal partial IntPtr RegisterDeviceNotification(IntPtr hRecipient, IntPtr notificationFilter, Int32 flags);

        [LibraryImport("setupapi.dll")]
        internal static partial int SetupDiCreateDeviceInfoList(ref Guid classGuid, int hwndParent);

        [LibraryImport("setupapi.dll")]
        internal static partial IntPtr SetupDiCreateDeviceInfoList(IntPtr guid, int hwndParent);


        [LibraryImport("setupapi.dll")]
	    static internal partial int SetupDiDestroyDeviceInfoList(IntPtr deviceInfoSet);

        [LibraryImport("setupapi.dll", EntryPoint = "SetupDiOpenDeviceInfoW", StringMarshalling = StringMarshalling.Utf16 )]
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static partial bool SetupDiOpenDeviceInfo(IntPtr deviceInfoSet, string deviceInstanceId, IntPtr parent, uint flags, ref SP_DEVINFO_DATA deviceInfoData);



        [LibraryImport("setupapi.dll")]
        [return: MarshalAs(UnmanagedType.Bool)]
        static internal partial bool SetupDiEnumDeviceInterfaces(IntPtr deviceInfoSet, ref SP_DEVINFO_DATA deviceInfoData, ref Guid interfaceClassGuid, int memberIndex, ref SP_DEVICE_INTERFACE_DATA deviceInterfaceData);


        [LibraryImport("setupapi.dll", EntryPoint = "SetupDiGetClassDevsW", StringMarshalling = StringMarshalling.Utf16)]
        static internal partial IntPtr SetupDiGetClassDevs(ref System.Guid classGuid, string enumerator, int hwndParent, int flags);


        [LibraryImport("setupapi.dll", EntryPoint = "SetupDiGetDeviceInterfaceDetailW", StringMarshalling = StringMarshalling.Utf16)]
        [return: MarshalAs(UnmanagedType.Bool)]
        static internal partial bool SetupDiGetDeviceInterfaceDetailBuffer(IntPtr deviceInfoSet, ref SP_DEVICE_INTERFACE_DATA deviceInterfaceData, IntPtr deviceInterfaceDetailData, int deviceInterfaceDetailDataSize, ref int requiredSize, IntPtr deviceInfoData);

        [LibraryImport("setupapi.dll", EntryPoint = "SetupDiGetDeviceInterfaceDetailW", StringMarshalling = StringMarshalling.Utf16)]
        [return: MarshalAs(UnmanagedType.Bool)]
        static internal partial bool SetupDiGetDeviceInterfaceDetail(IntPtr deviceInfoSet, ref SP_DEVICE_INTERFACE_DATA deviceInterfaceData, ref SP_DEVICE_INTERFACE_DETAIL_DATA deviceInterfaceDetailData, int deviceInterfaceDetailDataSize, ref int requiredSize, IntPtr deviceInfoData);

        [LibraryImport("setupapi.dll", EntryPoint = "SetupDiSetClassInstallParamsW", StringMarshalling = StringMarshalling.Utf16)]
        [return: MarshalAs(UnmanagedType.Bool)]
        static internal partial bool SetupDiSetClassInstallParams(IntPtr deviceInfoSet, ref SP_DEVINFO_DATA deviceInfoData, ref SP_PROPCHANGE_PARAMS classInstallParams, int classInstallParamsSize);

        [LibraryImport("setupapi.dll")]
        [return: MarshalAs(UnmanagedType.Bool)]
        static internal partial bool SetupDiCallClassInstaller(int installFunction, IntPtr deviceInfoSet, ref SP_DEVINFO_DATA deviceInfoData);

        [LibraryImport("setupapi.dll", EntryPoint = "SetupDiGetDeviceInstanceIdW", StringMarshalling = StringMarshalling.Utf16)]
        [return: MarshalAs(UnmanagedType.Bool)]
        static internal partial bool SetupDiGetDeviceInstanceId(IntPtr deviceInfoSet, ref SP_DEVINFO_DATA deviceInfoData, char[] deviceInstanceId, Int32 deviceInstanceIdSize, ref int requiredSize);

        [LibraryImport("cfgmgr32.dll", EntryPoint = "CM_Get_Device_Interface_PropertyW", StringMarshalling = StringMarshalling.Utf16)]
        static internal partial uint CM_Get_Device_Interface_Property(string pszDeviceInterface, ref DEVPROPKEY PropertyKey, out DEVPROPTYPE PropertyType, byte[] PropertyBuffer, ref uint PropertyBufferSize, uint ulFlags);


        [LibraryImport("user32.dll")]
		[return: MarshalAs(UnmanagedType.Bool)]
	    static internal partial bool UnregisterDeviceNotification(IntPtr handle);
	    ...
	    internal unsafe struct HIDP_CAPS
	    {
		    ...
		    internal fixed short Reserved[17];
		...
		[return: MarshalAs(UnmanagedType.Bool)]
	    static internal partial bool HidD_FlushQueue(IntPtr hidDeviceObject);


        [LibraryImport("hid.dll")]
        [return: MarshalAs(UnmanagedType.Bool)]
        static internal partial bool HidD_FlushQueue(SafeFileHandle hidDeviceObject);

        [LibraryImport("hid.dll")]
        [return: MarshalAs(UnmanagedType.Bool)]
        static internal partial bool HidD_GetAttributes(IntPtr hidDeviceObject, ref HIDD_ATTRIBUTES attributes);

        [LibraryImport("hid.dll")]
        [return: MarshalAs(UnmanagedType.Bool)]
        static internal partial bool HidD_GetFeature(IntPtr hidDeviceObject, byte[] lpReportBuffer, int reportBufferLength);

        [LibraryImport("hid.dll", SetLastError = true)]
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static partial Boolean HidD_GetInputReport(SafeFileHandle HidDeviceObject, Byte[] lpReportBuffer, Int32 ReportBufferLength);

        [LibraryImport("hid.dll")]
        [return: MarshalAs(UnmanagedType.Bool)]
        static internal partial void HidD_GetHidGuid(ref Guid hidGuid);

        [LibraryImport("hid.dll")]
        [return: MarshalAs(UnmanagedType.Bool)]
        static internal partial bool HidD_GetNumInputBuffers(IntPtr hidDeviceObject, ref int numberBuffers);

        [LibraryImport("hid.dll")]
        [return: MarshalAs(UnmanagedType.Bool)]
        static internal partial bool HidD_GetPreparsedData(IntPtr hidDeviceObject, ref IntPtr preparsedData);

        [LibraryImport("hid.dll")]
        [return: MarshalAs(UnmanagedType.Bool)]
        static internal partial bool HidD_FreePreparsedData(IntPtr preparsedData);

        [LibraryImport("hid.dll")]
        [return: MarshalAs(UnmanagedType.Bool)]
        static internal partial bool HidD_SetFeature(IntPtr hidDeviceObject, byte[] lpReportBuffer, int reportBufferLength);

        [LibraryImport("hid.dll")]
        [return: MarshalAs(UnmanagedType.Bool)]
        static internal partial bool HidD_SetFeature(SafeFileHandle hidDeviceObject, byte[] lpReportBuffer, int reportBufferLength);

        [LibraryImport("hid.dll")]
        [return: MarshalAs(UnmanagedType.Bool)]
        static internal partial bool HidD_SetNumInputBuffers(IntPtr hidDeviceObject, int numberBuffers);

        [LibraryImport("hid.dll")]
        [return: MarshalAs(UnmanagedType.Bool)]
        static internal partial bool HidD_SetOutputReport(IntPtr hidDeviceObject, byte[] lpReportBuffer, int reportBufferLength);

        [LibraryImport("hid.dll")]
        [return: MarshalAs(UnmanagedType.Bool)]
        static internal partial bool HidD_SetOutputReport(SafeFileHandle hidDeviceObject, byte[] lpReportBuffer, int reportBufferLength);

        [LibraryImport("hid.dll")] 
        static internal partial int HidP_GetCaps(IntPtr preparsedData, ref HIDP_CAPS capabilities);

        [LibraryImport("hid.dll")] 
        static internal partial int HidP_GetValueCaps(short reportType, ref byte valueCaps, ref short valueCapsLength, IntPtr preparsedData);

        [LibraryImport("hid.dll")]
        [return: MarshalAs(UnmanagedType.Bool)]
        static internal partial bool HidD_GetSerialNumberString(IntPtr HidDeviceObject, byte[] Buffer, ulong BufferLength);
    }
}
