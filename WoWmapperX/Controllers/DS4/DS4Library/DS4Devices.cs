...
namespace DS4Windows
{
    ...
    public class DS4Devices
    {
        ...
        public static event RequestElevationDelegate RequestElevation = DS4Devices_RequestElevation;
        public static PrepareInitDelegate PrepareDS4Init = PrepareDS4DeviceInit;
        public static PrepareInitDelegate PostDS4Init = PostDS4DeviceInit;
        public static CheckPendingDevice PreparePendingDevice = CheckForSupportedDevice;
        ...
        private static DeviceOptions deviceOptions = new DeviceOptions();
        ...
        private static void PrepareDS4DeviceInit(DS4Device device)
        {
            // Does nothing now
        }

        private static void DS4Devices_RequestElevation(RequestElevationArgs args)
        {
        ...
        public static void PostDS4DeviceInit(DS4Device device)
        {
        ...
        public static bool CheckForSupportedDevice(HidDevice device, VidPidInfo metaInfo)
        {
            bool result = false;
            switch (metaInfo.inputDevType)
            {
                case InputDevices.InputDeviceType.DS4:
                    result = true; //deviceOptions.DS4DeviceOpts.Enabled;
                    break;
                case InputDevices.InputDeviceType.DualSense:
                    result = true; //deviceOptions.DualSenseOpts.Enabled;
                    break;
                case InputDevices.InputDeviceType.SwitchPro:
                    result = true; //deviceOptions.SwitchProDeviceOpts.Enabled;
                    break;
                ...
                case InputDevices.InputDeviceType.JoyConGrip:
                    result = true; // deviceOptions.JoyConDeviceOpts.Enabled;
                    break;
                case InputDevices.InputDeviceType.DS3:
                    result = true; //deviceOptions.DS3DeviceOpts.Enabled;
                    break;
                default:
                    break;
            }
                ...
                //foreach (HidDevice hDevice in hDevices)
                {
                    ...
                    if (hDevice.IsOpen)
                    {
                        ...
                        if (newdev && validSerial)
                        {
                            ...
                            ds4Device.SyncChange += UpdateSerial;
