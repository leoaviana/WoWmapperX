...
namespace WoWmapperX.Input
{
    public static partial class HardwareInput
    {
        /// <summary>
        ...
        /// </returns>
        [LibraryImport("user32.dll", EntryPoint = "MapVirtualKeyW", StringMarshalling = StringMarshalling.Utf16)]
        private static partial int MapVirtualKey(uint uCode, MapVirtualKeyMapTypes uMapType);

        [LibraryImport("user32.dll")]
        internal static partial uint SendInput(uint nInputs,
                ...
                new INPUT
                {
                    ...
                    U = new InputUnion
                    {
                        mi = new MOUSEINPUT
                        {
                            ...
                            dx = (int)Cursor.Position.X,
                            dy = (int)Cursor.Position.Y
                        }
                    }
                }
            };
